...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Login as a user, get a token and use it to make your requests. The responses you see from the requests where made with the token of a user of role admin</b>.',
    ],
